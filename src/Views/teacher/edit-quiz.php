...
<div class="flex">
    ...
    <div class="flex-1 p-8">
        ...
        <header class="flex items-center justify-between mb-6">
            <div>
                <h1 class="text-3xl font-bold tracking-tight text-white">Edit Quiz</h1>
                <p class="text-sm text-[#CBD5E1] mt-2">Update quiz details and information</p>
            </div>
        ...
        <main class="max-w-3xl mx-auto">
            ...
            <form method="POST" class="bg-[#1E293B] p-7 rounded-xl shadow-lg border border-[#475569]/30 hover:border-[#475569]/50 transition-all duration-300">
                ...
                <div class="flex items-center gap-3 pt-4 border-t border-[#334155]">
                    <button type="submit" class="px-5 py-2.5 bg-gradient-to-r from-[#2563EB] to-[#1D4ED8] text-white rounded-lg hover:from-[#1D4ED8] hover:to-[#1E40AF] transition-all duration-300 transform hover:scale-105 shadow-lg shadow-blue-500/20 font-medium">Save Changes</button>
                    <a href="dashboard.php" class="px-5 py-2.5 bg-[#1e293b] border border-[#334155] rounded-lg text-[#CBD5E1] hover:bg-[#334155] font-medium transition-all duration-300">Cancel</a>
                </div>
            </form>
